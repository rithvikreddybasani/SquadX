...
export const Button = styled.button`
    ...
    background: ${({ theme }) => theme.primary}; /* Primary color */
    background: linear-gradient(
        225deg,
        #28a745 0%, /* Green start */
        #218838 100% /* Darker green end */
    );
...
function FormComponent() {
    ...
    return (
        <ThemeProvider theme={darkTheme}>
            ...
            <h1 className="text-6xl sm:text-7xl font-semibold text-white">DevSync</h1>
